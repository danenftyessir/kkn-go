...
<section class="py-24 bg-gradient-to-br from-blue-50 to-white">
    <div class="container mx-auto px-6">
        <div class="max-w-7xl mx-auto">
            ...
            {{-- header --}}
            <h2 class="text-4xl md:text-5xl font-bold text-blue-700 mb-16">
                Keberhasilan Ini Adalah Hasil Sinergi Kita Bersama
            </h2>

            {{-- year buttons dan arrows --}}
            <div class="flex items-center justify-between mb-16">
                <div class="flex gap-3">
                    <button onclick="goToYear(2020)" class="year-button">20</button>
                    <button onclick="goToYear(2021)" class="year-button active">Tahun 2021</button>
                    <button onclick="goToYear(2022)" class="year-button">22</button>
                    <button onclick="goToYear(2023)" class="year-button">23</button>
                    <button onclick="goToYear(2024)" class="year-button">24</button>
                    <button onclick="goToYear(2025)" class="year-button">25</button>
                </div>
                <div class="flex gap-3">
                    <button onclick="scrollLeft()" class="arrow-button">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                        </svg>
                    </button>
                    <button onclick="scrollRight()" class="arrow-button">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- timeline container --}}
            <div class="relative overflow-x-auto pb-8" id="timelineContainer">
                <div class="flex min-w-max relative" style="padding-top: 20px; padding-bottom: 40px;">
                    
                    {{-- garis horizontal --}}
                    <div class="absolute top-1/2 left-0 right-0 h-0.5 bg-blue-600 transform -translate-y-1/2" style="margin-top: 20px;"></div>
                    
                    {{-- item 2020 --}}
                    <div class="flex-shrink-0" style="width: 400px;" data-year="2020">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-gray-600 mb-3">Identifikasi Masalah</p>
                            <div class="relative flex items-center justify-start w-full mb-8">
                                <div class="w-3 h-3 bg-blue-600 rounded-full relative z-10"></div>
                            </div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-3">
                                Analisis Ekosistem KKN Indonesia
                            </h3>
                            <p class="text-sm text-gray-700 mb-1">Temuan:</p>
                            ...
                            <p class="text-sm text-gray-600">Tingkat: <span class="font-medium">Riset Nasional</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0" style="width: 400px;" data-year="2021">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-gray-600 mb-3">Studi Kebutuhan</p>
                            <div class="relative flex items-center justify-start w-full mb-8">
                                <div class="w-3 h-3 bg-blue-600 rounded-full relative z-10"></div>
                            </div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-3">
                            ...
                            <p class="text-sm text-gray-700 mb-1">Hasil:</p>
                            <p class="text-base text-gray-800 mb-3">
                                68% kepala desa merasa program KKN tidak menjawab masalah utama desa mereka
                            </p>
                            <p class="text-sm text-gray-600">Tingkat: <span class="font-medium">5 Provinsi</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0" style="width: 400px;" data-year="2022">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-gray-600 mb-3">Konsep Platform</p>
                            <div class="relative flex items-center justify-start w-full mb-8">
                                <div class="w-3 h-3 bg-blue-600 rounded-full relative z-10"></div>
                            </div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-3">
                            ...
                            <p class="text-sm text-gray-700 mb-1">Inovasi:</p>
                            <p class="text-base text-gray-800 mb-3">
                                Marketplace masalah, Impact Portfolio, dan Knowledge Repository terintegrasi
                            </p>
                            <p class="text-sm text-gray-600">Tingkat: <span class="font-medium">Prototype</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0" style="width: 400px;" data-year="2023">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-gray-600 mb-3">Pilot Project</p>
                            <div class="relative flex items-center justify-start w-full mb-8">
                                <div class="w-3 h-3 bg-blue-600 rounded-full relative z-10"></div>
                            </div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-3">
                            ...
                            <p class="text-sm text-gray-700 mb-1">Capaian:</p>
                            <p class="text-base text-gray-800 mb-3">
                                Peningkatan relevansi program KKN hingga 78% dan efisiensi waktu 30%
                            </p>
                            <p class="text-sm text-gray-600">Tingkat: <span class="font-medium">3 Universitas</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0" style="width: 400px;" data-year="2024">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-gray-600 mb-3">Ekspansi Nasional</p>
                            <div class="relative flex items-center justify-start w-full mb-8">
                                <div class="w-3 h-3 bg-blue-600 rounded-full relative z-10"></div>
                            </div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-3">
                            ...
                            <p class="text-sm text-gray-700 mb-1">Target:</p>
                            <p class="text-base text-gray-800 mb-3">
                                Partnership dengan 100+ perguruan tinggi dan 1.000+ pemerintah daerah
                            </p>
                            <p class="text-sm text-gray-600">Tingkat: <span class="font-medium">Skala Nasional</span></p>
                        </div>
                    </div>

                    {{-- item 2025 --}}
                    <div class="flex-shrink-0" style="width: 400px;" data-year="2025">
                        <div class="flex flex-col items-start">
                            <p class="text-sm text-gray-600 mb-3">Platform KKN-Go</p>
                            <div class="relative flex items-center justify-start w-full mb-8">
                                <div class="w-3 h-3 bg-blue-600 rounded-full relative z-10"></div>
                            </div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-3">
                            ...
                            <p class="text-sm text-gray-700 mb-1">Dampak:</p>
                            <p class="text-base text-gray-800 mb-3">
                                Mengubah 520.000+ mahasiswa KKN/tahun menjadi agen perubahan terukur untuk pembangunan desa
                            </p>
                            <p class="text-sm text-gray-600">Tingkat: <span class="font-medium">Transformasi Digital</span></p>
                        </div>
                    </div>
...
<script>
    ...
    function goToYear(year) {
        ...
        // scroll to item
        if (item) {
            const scrollPosition = item.offsetLeft - 40;
