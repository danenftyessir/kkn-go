                ...
                @auth
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        ...
                        <div 
                            ...
                            class="absolute right-0 mt-2 w-52 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden z-[9999]"
                            @click.stop>
                            ...
                            <div>
                                <a href="{{ route(auth()->user()->user_type . '.profile.index') }}" 
                                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                            ...
                            <div class="border-t border-gray-100">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" 
                                            class="flex items-center w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors text-left">
